	...
	return (
		<section className="relative overflow-hidden bg-zinc-950 h-dvh flex items-center justify-center">
			...
			<div className="absolute inset-0">
				...
				{/* Animated SVG Mask - Organic cloud-like blob with wavy bottom */}
				<svg className="absolute inset-0 w-full h-full pointer-events-none">
					<defs>
						<clipPath id="blobMask" clipPathUnits="objectBoundingBox">
							{/* Main blob path - starts left, goes around top, right, then big wavy bottom */}
							<path d="
								M 0.02,0.15
								...
								Z
							">
								{/* Animate only the edges - subtle breathing effect */}
								<animate
									attributeName="d"
									dur="15s"
									...
									values="
										...
										M 0.01,0.18
										C 0.00,0.10 0.02,0.03 0.07,0.015
										C 0.14,0.00 0.24,0.005 0.34,0.01
										C 0.44,0.015 0.54,0.01 0.64,0.005
										C 0.74,0.00 0.84,0.005 0.91,0.015
										C 0.98,0.025 0.995,0.10 0.99,0.18
										L 0.99,0.68
										C 0.96,0.73 0.91,0.76 0.86,0.78
										Q 0.76,0.81 0.66,0.83
										Q 0.56,0.85 0.46,0.83
										Q 0.36,0.81 0.26,0.78
										Q 0.16,0.75 0.06,0.71
										C 0.04,0.70 0.01,0.67 0.01,0.63
										L 0.01,0.18
										Z;

										M 0.015,0.12
										C 0.005,0.06 0.025,0.015 0.075,0.005
										C 0.145,0.00 0.245,0.01 0.345,0.015
										C 0.445,0.02 0.545,0.015 0.645,0.01
										C 0.745,0.005 0.845,0.00 0.915,0.005
										C 0.975,0.01 0.995,0.06 0.985,0.12
										L 0.985,0.62
										C 0.955,0.68 0.905,0.71 0.855,0.73
										Q 0.755,0.76 0.655,0.78
										Q 0.555,0.80 0.455,0.78
										Q 0.355,0.76 0.255,0.73
										Q 0.155,0.70 0.055,0.66
										C 0.035,0.65 0.015,0.62 0.015,0.58
										L 0.015,0.12
										Z;

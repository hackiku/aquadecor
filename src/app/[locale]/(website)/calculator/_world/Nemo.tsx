// src/app/(website)/calculator/_world/Nemo.tsx
"use client";
...
export function Nemo({ tankWidth, tankHeight, tankDepth, otherFishRef }: NemoProps) {
	...
	// Physics state - Nemo starts lower-right, moving left and up
	const [velocity] = useState(() => new THREE.Vector3(-0.013, 0.005, 0.007));
	const [position] = useState(() => new THREE.Vector3(bounds.x * 0.5, -bounds.y * 0.3, -bounds.z * 0.2));

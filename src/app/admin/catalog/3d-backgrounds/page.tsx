// src/app/admin/catalog/3d-backgrounds/page.tsx
...
export default async function ThreeDBackgroundsPage() {
	const productLine = "3d-backgrounds";
				...
				<div className="flex items-start justify-between">
					<div className="space-y-2">
						...
						<p className="text-muted-foreground font-display font-light text-lg">
							Custom-made aquarium backgrounds
						</p>
					</div>
			...
			<div className="space-y-4">
				<div className="flex items-center justify-between">
					...
					<Button variant="outline" size="sm" asChild className="rounded-full">
						<Link href="/admin/catalog/categories?productLine=3d-backgrounds">
							View All
						</Link>
					</Button>
				</div>
